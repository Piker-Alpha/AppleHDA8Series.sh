...
#
gInfoPlist="${gTargetDirectory}/AppleHDA892.kext/Contents/Info.plist"
...
function _creatInfoPlist()
{
  ...
  echo '	<string>AppleHDA892 1.0.1a10, Copyright © 2003-2014 Pike R. Alpha. All rights reserved.</string>'   >> $gInfoPlist
  echo '	<key>CFBundleIdentifier</key>'                                                                      >> $gInfoPlist
  echo '	<string>com.apple.driver.AppleHDA892</string>'                                                      >> $gInfoPlist
  ...
  echo '	<string>Realtek 892 Configuation Driver</string>'                                                   >> $gInfoPlist
...
function main()
{
  ...
  echo "Creating AppleHDA892.kext in: $gTargetDirectory\n"

  #
  # Make target directory structure.
  #
  mkdir -m 755 -p "${gTargetDirectory}/AppleHDA892.kext/Contents/PlugIns/AppleHDALoader.kext/Contents/Resources"

  #
  # Copy the Platforms file from the source directory.
  #
  cp "${gSourceDirectory}/Platforms.xml.zlib" "${gTargetDirectory}/AppleHDA892.kext/Contents/PlugIns/AppleHDALoader.kext/Contents/Resources/"

  #
  # Copy the layout file from the source directory.
  #
  cp "${gSourceDirectory}/layout3.xml.zlib" "${gTargetDirectory}/AppleHDA892.kext/Contents/PlugIns/AppleHDALoader.kext/Contents/Resources/"

  #
  # Add MacOS directory for our symbolic link.
  #
  mkdir "${gTargetDirectory}/AppleHDA892.kext/Contents/PlugIns/AppleHDALoader.kext/Contents/MacOS"

  #
  # Create symbolic link to executable.
  #
  ln -fs "${gExtensionsDirectory}/AppleHDA.kext/Contents/MacOS/AppleHDA" "${gTargetDirectory}/AppleHDA892.kext/Contents/PlugIns/AppleHDALoader.kext/Contents/MacOS/AppleHDA"
  ...
  #
  cp "${gExtensionsDirectory}/AppleHDA.kext/Contents/Info.plist" "${gTargetDirectory}/AppleHDA892.kext/Contents/PlugIns/AppleHDALoader.kext/Contents/"

  #
  # Copy CodeResources.
  #
  cp -R "${gExtensionsDirectory}/AppleHDA.kext/Contents/PlugIns/DspFuncLib.kext/Contents/_CodeSignature" "${gTargetDirectory}/AppleHDA892.kext/Contents/"

  gTargetFile="${gTargetDirectory}/AppleHDA892.kext/Contents/PlugIns/AppleHDALoader.kext/Contents/Info.plist"
